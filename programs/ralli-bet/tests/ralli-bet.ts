...
describe("RalliBet Comprehensive Tests", () => {
  ...
  before(async () => {
    ...
    users = [user1, user2, user3, user4, user5, user6, user7, treasury];
  ...
  describe("Resolve Game Tests", () => {
    ...
    before(async () => {
      ...
      // const users9 = [user1, user2, user3, keypair, user4, user5];
      // const userTokenAccounts9 = [user1TokenAccount, user2TokenAccount, user3TokenAccount, providerTokenAccount, user4TokenAccount, user5TokenAccount];
      ...
      // const users11 = [user1, user2, user3, keypair, user4];
      // const userTokenAccounts11 = [user1TokenAccount, user2TokenAccount, user3TokenAccount, providerTokenAccount, user4TokenAccount];
