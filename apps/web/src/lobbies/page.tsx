  ...
  const allLobbies = [
    {
      ...
      legs: 4,
      timeLeft: '2h 15m',
      host: { username: 'Jack Sturt', avatar: 'JS' },
      isUrgent: false,
    ...
    },
    {
      ...
      legs: 5,
      timeLeft: '45m',
      host: { username: 'Mike Chen', avatar: 'MC' },
      isUrgent: true,
      status: 'waiting' as const,
    },
    {
      ...
      legs: 3,
      timeLeft: '1h 30m',
      host: { username: 'Sarah J', avatar: 'SJ' },
      isUrgent: false,
      status: 'waiting' as const,
    },
    {
      ...
      legs: 6,
      timeLeft: 'Live',
      host: { username: 'Alex Rodriguez', avatar: 'AR' },
      isUrgent: false,
    ...
    },
    {
      ...
      legs: 4,
      timeLeft: 'Live',
      host: { username: 'Emma Wilson', avatar: 'EW' },
      isUrgent: false,
      status: 'active' as const,
    },
    {
      ...
      legs: 5,
      timeLeft: 'Completed',
      host: { username: 'David Kim', avatar: 'DK' },
      isUrgent: false,
    ...
    },
    {
      ...
      legs: 8,
      timeLeft: 'Completed',
      host: { username: 'Michael Torres', avatar: 'MT' },
      isUrgent: false,
      status: 'complete' as const,
    },
    {
      ...
      legs: 3,
      timeLeft: 'Processing',
      host: { username: 'Lisa Chang', avatar: 'LC' },
      isUrgent: false,
    ...
    },
    {
      ...
      legs: 4,
      timeLeft: 'Processing',
      host: { username: 'Roberto Silva', avatar: 'RS' },
      isUrgent: false,
      status: 'pending' as const,
    },
    {
      ...
      legs: 5,
      timeLeft: '3h 45m',
      host: { username: 'Anna Johnson', avatar: 'AJ' },
      isUrgent: false,
      status: 'waiting' as const,
    },
    {
      ...
      legs: 4,
      timeLeft: 'Live',
      host: { username: 'Tom Bradley', avatar: 'TB' },
      isUrgent: false,
      status: 'active' as const,
    },
    {
      ...
      legs: 7,
      timeLeft: 'Completed',
      host: { username: 'Jennifer Lee', avatar: 'JL' },
      isUrgent: false,
      status: 'complete' as const,
    },
  ]
