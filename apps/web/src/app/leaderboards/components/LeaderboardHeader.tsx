  ...
  return (
    <>
      ...
      <div className="text-center py-8 px-4">
        <div className="mb-6">
          <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-[#00CED1]/20 to-[#FFAB91]/20 backdrop-blur-sm border border-white/20 rounded-2xl flex items-center justify-center shadow-xl">
            <span className="text-2xl">🏆</span>
          </div>
        </div>
        <h1 className="text-3xl font-bold bg-gradient-to-r from-[#00CED1] to-[#FFAB91] bg-clip-text text-transparent mb-3">
          Player Rankings
        </h1>
        <p className="text-slate-400 text-lg">See who's dominating the competition</p>
      </div>
    </>
  )
}
