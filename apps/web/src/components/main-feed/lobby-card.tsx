...
export default function LobbyCard({
  ...
  return (<div className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-sm rounded-3xl p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all duration-300 group hover:transform hover:scale-[1.01] shadow-xl relative min-h-[280px]">
        ...
        <div className="flex-1">
          <div className="flex items-center space-x-2 mb-1">
            {host.avatar && host.avatar !== '' ? (
              <Image src={imageSrc || '/images/pfp-1.svg'} alt={host.username} width={24} height={24} />
            ) : null}
