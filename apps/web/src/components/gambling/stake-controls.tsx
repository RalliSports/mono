      ...
      <div className="flex items-center justify-between mb-8 relative z-10">
        <h3 className="text-2xl font-bold text-white flex items-center">
          <div className="w-12 h-12 bg-gradient-to-br from-[#00CED1]/20 to-[#FFAB91]/20 rounded-xl flex items-center justify-center mr-3 border border-[#00CED1]/30">
            <svg className="w-6 h-6 text-[#00CED1]" fill="currentColor" viewBox="0 0 20 20">
              <path
                fillRule="evenodd"
      ...
      <div className="mb-8 relative z-10">
        <div className="flex items-center justify-between mb-6">
          <label className="text-white text-lg font-bold flex items-center">
            <div className="w-8 h-8 bg-gradient-to-br from-[#FFAB91]/20 to-[#00CED1]/20 rounded-lg flex items-center justify-center mr-2">
              <svg className="w-4 h-4 text-[#FFAB91]" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="text-right">
            ...
            <div className="text-[#FFAB91] font-bold text-lg">{multiplier}x</div>
          </div>
        </div>

        <div className="flex items-center space-x-4 mb-6">
          <button
            onClick={() => setMultiplier(Math.max(1.1, Number((multiplier - 0.1).toFixed(1))))}
        ...
        {multiplier >= 3.0 && (
          <div className="mt-4 flex items-center space-x-2 p-3 bg-red-500/10 border border-red-500/30 rounded-xl">
            ...
            <span className="text-red-400 text-sm font-medium">High risk multiplier selected</span>
          </div>
        )}
      </div>{' '}
      {/* Potential Payout */}
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-slate-900/50 to-slate-800/50 rounded-xl border border-slate-700/30">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-slate-300 text-sm">Total Prize Pool</div>
                    <div className="text-white text-xs">Winner takes all</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-[#00CED1] font-bold text-2xl">${totalPool.toFixed(2)}</div>
              ...
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-slate-900/50 to-slate-800/50 rounded-xl border border-slate-700/30">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-slate-300 text-sm">Your Net Profit</div>
                    <div className="text-white text-xs">If you win</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-emerald-400 font-bold text-2xl">+${(totalPool - stake).toFixed(2)}</div>
              ...
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-slate-900/50 to-slate-800/50 rounded-xl border border-slate-700/30">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-slate-300 text-sm">Competition Level</div>
                ...
                <div className="text-right">
                  ...
                  >
                    {activePlayersCount <= 5 ? 'Low' : activePlayersCount <= 10 ? 'Medium' : 'High'}
                  </div>
                  <div className="text-slate-400 text-sm">~{(100 / activePlayersCount).toFixed(1)}% chance</div>
                </div>
              </div>
            </div>
