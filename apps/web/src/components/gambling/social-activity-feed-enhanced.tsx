  ...
  const feedItems: FeedItem[] = [
    {
      ...
      description:
        "5-leg parlay showdown • Premium contest with guaranteed prizes",
      time: "2 minutes ago",
    ...
    <div className="max-w-6xl mx-auto relative">
      ...
      <div className="text-center mb-12 relative z-10">
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
          Stay connected with friends, discover hot lobbies, celebrate big wins,
          and follow the pulse of the community.
        </p>
      </div>
        ...
        <div className="space-y-8 relative z-10">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-slate-400 text-sm">
              {filteredItems.length} activities • Updated now
            </div>
          </div>
              ...
              {item.type === "lobby" && (
                <div className="relative z-10">
                  ...
                  >
                    ...
                    <span>
                      Join Battle ({item.maxParticipants! - item.participants!}{" "}
                      spots left)
                    </span>
                  </button>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <div className="flex items-center space-x-3 mt-2">
                            <span className="text-[#FFAB91] font-bold text-lg">
                              {item.bet.odds}
                            </span>
                        ...
                        <div>
                          ...
                          <div className="text-[#FFAB91] font-semibold text-sm">
                            {item.bet.game}
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="bg-gradient-to-r from-emerald-500/10 to-emerald-400/10 border border-emerald-400/30 rounded-3xl p-8 mb-6">
                    ...
                    <div className="grid grid-cols-3 gap-6 mb-6">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-[#FFAB91] font-bold text-2xl">
                          {item.multiplier}
                        </div>
                      </div>
                    </div>
