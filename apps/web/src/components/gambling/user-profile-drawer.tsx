      ...
      <div className="max-h-[1100px] overflow-y-auto">
        ...
        <div className="p-8 border-b border-slate-700/30">
          <div className="flex items-center space-x-6 mb-6">
            ...
            <div className="flex-1">
              <h3 className="text-2xl font-bold text-white mb-2">{userStats.name}</h3>
              <p className="text-slate-300 text-lg mb-2">{userStats.username}</p>
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-emerald-400 rounded-full animate-pulse"></div>
                <span className="text-emerald-400 text-base font-semibold">Online</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-[#00CED1]/10 to-[#FFAB91]/10 rounded-3xl p-6 border border-[#00CED1]/20 shadow-inner">
            <div className="text-center">
              <div className="text-4xl font-bold text-white mb-3">${userStats.balance.toLocaleString()}</div>
        ...
        <div className="p-8 border-b border-slate-700/30">
          <h4 className="text-xl font-semibold text-white mb-6 flex items-center">
            <svg className="w-6 h-6 text-[#FFAB91] mr-3" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="bg-slate-800/50 rounded-3xl p-6 shadow-inner">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-[#00CED1] font-bold text-2xl">#{userStats.rank}</span>
            </div>
            <div className="flex items-center justify-between mb-4">
              <span className="text-slate-300 text-lg">Out of:</span>
              <span className="text-white font-semibold text-lg">{userStats.totalUsers.toLocaleString()} players</span>
            </div>
        ...
        <div className="p-8 border-b border-slate-700/30">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-slate-800/50 rounded-2xl p-5 text-center shadow-inner">
              <div className="text-[#00CED1] font-bold text-2xl mb-2">{userStats.winRate}%</div>
              <div className="text-slate-400 text-sm">Win Rate</div>
            </div>
            <div className="bg-slate-800/50 rounded-2xl p-5 text-center shadow-inner">
              <div className="text-[#FFAB91] font-bold text-2xl mb-2">{userStats.totalBets}</div>
              <div className="text-slate-400 text-sm">Total Bets</div>
            </div>
            <div className="bg-slate-800/50 rounded-2xl p-5 text-center shadow-inner">
              <div className="text-emerald-400 font-bold text-2xl mb-2">${userStats.avgBet}</div>
              <div className="text-slate-400 text-sm">Avg Bet</div>
            </div>
            <div className="bg-slate-800/50 rounded-2xl p-5 text-center shadow-inner">
              <div className="text-violet-400 font-bold text-2xl mb-2">{userStats.currentStreak}</div>
